...
complete_ticket_list = {
    # Job 1.
    1: {"ticket_id": 1, "machine_type": 0, "duration": 20, "parents": [], "num_robots": 3},
    ...
    # Job 3.
    9: {"ticket_id": 9, "machine_type": 0, "duration": 23, "parents": [], "num_robots": 2},
    ...
    # Job 4.
    13: {"ticket_id": 13, "machine_type": 0, "duration": 20, "parents": [], "num_robots": 2},
    ...
    # Job 5.
    17: {"ticket_id": 17, "machine_type": 0, "duration": 20, "parents": [], "num_robots": 3},
    ...
    # Job 7.
    25: {"ticket_id": 25, "machine_type": 0, "duration": 20, "parents": [], "num_robots": 3},
