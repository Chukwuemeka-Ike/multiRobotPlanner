...
X, Y, Z, S, C, C_job, C_max = create_opt_variables(solver, jobs_data, horizon, all_machines, Mj)
define_constraints(solver, X, Y, Z, S, C, C_job, C_max, jobs_data, parent_ids, Mj)
...
# robot_timelines.to_csv("Plans/robotTimelinesPhysicalDemo.csv")